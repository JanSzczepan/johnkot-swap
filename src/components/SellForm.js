...
class SellForm extends Component {
   ...
   handleInputChange = (e) => {
      ...
      this.setState({ output: String(tokenAmount / this.props.rate) })
      ...
      return (
         <form onSubmit={this.handleFormSubmit}>
               ...
               <div className=" card-body">
                  ...
                  <div className="input-group input-group-lg">
                     <span className="coin-box input-group-text bg-transparent text-light" id="inputGroup-sizing-lg">
                        <img src={CATLogo} className='me-2' alt='Eth logo' height='22px'/>
                        KOT
                     </span>
               ...
               <div className=" card-body">
                  ...
                  <div className="input-group input-group-lg">
                     <span className="coin-box input-group-text bg-transparent text-white" id="inputGroup-sizing-lg">
                        <img src={ETHLogo} className='me-2' alt='CAT token logo' height='30px'/>
                        ETH
                     </span>  
            ...
            <div className='d-flex align-items-center justify-content-between mb-4'>
               ...
               <p className='text-light m-0 text-end'>100 KOT = 1 ETH</p>
            </div>
